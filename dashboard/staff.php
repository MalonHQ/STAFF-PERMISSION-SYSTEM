...
// Chukua requests za user pamoja na full_name
...
<title>Staff Dashboard - Staff Permission System</title>
<style>
  * { margin:0; padding:0; box-sizing:border-box; font-family: Arial, sans-serif; }
  ...
  .new-request { text-decoration:none; background:#28a745; color:white; padding:8px 15px; border-radius:6px; transition:0.3s; margin-bottom:15px; display:inline-block;}
  .new-request:hover { background:#218838; }
